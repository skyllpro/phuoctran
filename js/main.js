...
$(window).load(function() {
    ...
    //LOADER
    $("#background").delay(250).fadeOut(200);
    $(".spinner").delay(125).fadeOut("slow");
    $(".frame-loading").delay(125).fadeOut("slow");
...
$(document).ready(function() {
    ...
    ske = $('.owl-experience').owlCarousel();
    
    $(".prev-slide").on("click", function() {
        ske.trigger('owl.prev');
    });

    $(".next-slide").on("click", function() {
        ske.trigger('owl.next');
    });
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        $.ajax({
                url: "https://phuoctran.info/sendmail/sendmail.php",
                type: "POST",
